...
public:
    ...
    struct iterator {
        ...
        iterator() = default;
        iterator(std::list<int>::iterator _it, std::vector<std::pair<Node, bool>>& _array): it(_it), array(&_array){}
        std::pair<const KeyType, ValueType>& operator* () {
            return reinterpret_cast<std::pair<const KeyType, ValueType>&>((*array)[*it].first.entry);
        }
        std::pair<const KeyType, ValueType>* operator-> () {
            return reinterpret_cast<std::pair<const KeyType, ValueType>*>(&(((*array)[*it].first.entry)));
        }
    ...
    struct const_iterator {
        ...
        const_iterator() {}
        const_iterator(iterator& _it): it(_it.it), arr(_it.array){}
