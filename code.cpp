...
public:
    ...
    struct Node {
        std::pair<const KeyType, ValueType> entry;
        iterator it;
        const_iterator const_iterator;
        bool flag;
        Node() = default;
        Node(const KeyType _key, ValueType _val, iterator _it):
                entry(std::pair<const KeyType, ValueType>(_key, _val)), it(_it), flag(true) {}
    };
